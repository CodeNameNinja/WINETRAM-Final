...
public class BlueLineSceen extends AppCompatActivity {

    public static final String SHARED_PREFS = "sharedPrefs";
    private boolean switchOnOff;
    String TAG = BlueLineSceen.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(SelectRoute.selectedRoute == 1) {
    ...
    void conditions()
    {
        DatabaseReference mReference = Ref.child("BlueLine").child("bus");
    ...
    void busNotificationsBody(String BusLocation)
    {
        ...
        String message = "";
        Notification notification = new NotificationCompat.Builder(BlueLineSceen.this, CHANNEL_2_ID)
