...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ExampleViewHolder> {
    private ArrayList<RecyclerItem> mExampleList;
    ...
    public RecyclerAdapter(ArrayList<RecyclerItem> exampleList) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        RecyclerItem currentItem = mExampleList.get(position);
